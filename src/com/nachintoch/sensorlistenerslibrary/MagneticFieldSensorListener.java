...
/**
 * Escucha un sensor de campos magn&eacute;ticos.
 * @author <a href="mailto:manuelignacio_castillolpez@yahoo.com">nacintoch</a>
 * @version 1.0, enero 2013.
 */
public abstract class MagneticFieldSensorListener extends NachintochSensorListener {
	...
	/**
	 * Construye un observador de magnet&oacute;metro <i>nachintoch</i> con el
	 ...
	 */
	public MagneticFieldSensorListener(TextView view, Activity activity){
		super(view, activity, Sensor.TYPE_MAGNETIC_FIELD);
	 ...
	 */
	public MagneticFieldSensorListener(TextView view, Service service){
		super(view, service, Sensor.TYPE_MAGNETIC_FIELD);
	 ...
	 * @return MagneticFieldSensorListener - Una instancia de &eacute;sta clase.
	 */
	public static MagneticFieldSensorListener getInstance(){
		return new MagneticFieldSensorListener() {
...
}//MagneticFieldSensorListener class
