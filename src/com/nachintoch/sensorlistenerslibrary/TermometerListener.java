...
/**
 * Escucha el term&oacute;metro.
 * @author <a href="mailto:manuelignacio_castillolpez@yahoo.com">nacintoch</a>
 * @version 1.0, enero 2013
 */
public abstract class TermometerListener extends NachintochSensorListener {
	 ...
	 */
	public TermometerListener(){
		super(Sensor.TYPE_AMBIENT_TEMPERATURE);
	}//constructor por omisión
	
	/**
	 * Construye un observador de term&oacute;metro <i>nachintoch</i> con el
	 ...
	 */
	public TermometerListener(TextView view, Activity activity){
		super(view, activity, Sensor.TYPE_AMBIENT_TEMPERATURE);
	 ...
	 * @see NachintochSensorListener#NachintochSensorListener(android.widget.TextView, android.app.Service, int)
	 */
	public TermometerListener(TextView view, Service service){
		super(view, service, Sensor.TYPE_AMBIENT_TEMPERATURE);
	}//constructor con característica de gui update y servicio
	
	// métodos de acceso
	
	/**
	 * Indica la temperatura ambiente de la habitaci&oacute;n registrada.
	 ...
	 * @return TermometerListener - Una instancia de &eacute;sta clase.
	 */
	public static TermometerListener getInstance(){
		return new TermometerListener() {
