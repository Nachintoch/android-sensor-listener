...
/**
 * Escucha un sensor de aceleraci&oacute;n lineal.
 * @author <a href="mailto:manuelignacio_castillolpez@yahoo.com">nacintoch</a>
 * @version 1.0, enero 2013
 */
public abstract class LinearAccelerationSensorListener extends
	...
	/**
	 * Construye un observador de sensor de aceleraci&oacute;n lineal
	 * <i>nachintoch</i> con el <tt>TextView</tt> y actividad dados.
	 ...
	 */
	public LinearAccelerationSensorListener(TextView view, Activity activity){
		super(view, activity, Sensor.TYPE_LINEAR_ACCELERATION);
	}//constructor con característica de gui update y actividad
	
	/**
	 * Construye un observador de sensor de aceleraci&oacute;n lineal
	 * <i>nachintoch</i> con el <tt>TextView</tt> y servicio dados.
	 ...
	 */
	public LinearAccelerationSensorListener(TextView view, Service service){
		super(view, service, Sensor.TYPE_LINEAR_ACCELERATION);
	 ...
	 * @return LinearAccelerationSensorListener - Una instancia de &eacute;sta clase.
	 */
	public static LinearAccelerationSensorListener getInstance(){
		return new LinearAccelerationSensorListener() {
...
}//LinearAccelerationSensorListener class
