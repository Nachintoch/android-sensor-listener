...
/**
 * Escucha un aceler&oacute;metro.
 * @author <a href="mailto:manuelignacio_castillolpez@yahoo.com">nacintoch</a>
 * @version 1.0, Enero 2013.
 */
public abstract class AccelerometerListener extends NachintochSensorListener {
	...
	/**
	 * Construye un observador de aceler&oacute;metro <i>nachintoch</i> con el
	 ...
	 */
	public AccelerometerListener(TextView view, Activity activity){
		super(view, activity, Sensor.TYPE_ACCELEROMETER);
	 ...
	 */
	public AccelerometerListener(TextView view, Service service){
		super(view, service, Sensor.TYPE_ACCELEROMETER);
	 ...
	 * @return AccelerometerListener - Una instancia de &eacute;sta clase.
	 */
