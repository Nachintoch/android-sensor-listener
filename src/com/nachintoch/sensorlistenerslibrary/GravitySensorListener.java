...
/**
 * Escucha un sensor de gravedad.
 * @author <a href="mailto:manuelignacio_castillolpez@yahoo.com">nacintoch</a>
 * @version 1.0, enero 2013.
 */
public abstract class GravitySensorListener extends NachintochSensorListener {
	...
	/**
	 * Construye un observador de sensor de gravedad <i>nachintoch</i> con el
	 ...
	 */
	public GravitySensorListener(TextView view, Activity activity){
		super(view, activity, Sensor.TYPE_GRAVITY);
	 ...
	 */
	public GravitySensorListener(TextView view, Service service){
		super(view, service, Sensor.TYPE_GRAVITY);
	 ...
	 * @return GravitySensorListener - Una instancia de &eacute;sta clase.
	 */
	public static GravitySensorListener getInstance(){
		return new GravitySensorListener() {
